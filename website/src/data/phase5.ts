...
const LAB_FILE = "labs/phase_5_fs/COURSE.zh-CN.md";
const LAB_FILE_EN = "labs/phase_5_fs/COURSE.en.md";

export const phase5ZhCN: PhaseContent = {
  phaseId: 5, color: "#DC2626", accent: "#F87171",
  lessons: [
    {
      phaseId: 5, lessonId: 1,
      title: "Phase 5 导读：块设备与文件系统",
      ...
      sections: [
        {
          title: "本 Phase 的关键主题",
          blocks: [
            { type: "paragraph", text: "Phase 5 聚焦于 块设备与文件系统。完整教材（含 ASCII 图、代码剖析、常见错误表、三层级参考资料）请打开 labs 目录下的 COURSE.zh-CN.md 阅读；这里只做路线摘要。" },
            { type: "list", ordered: true, items: [
              "easy-fs 磁盘 5 区布局",
              "DiskInode：直接/一级/二级间接块",
              "BlockCache：LRU + 写回"
            ]},
            { type: "callout", variant: "tip", text: "打开终端进入 labs/phase_5_fs/，先 make test 再 make qemu，再读 COURSE.zh-CN.md 对照代码——这是最高效的学习路径。" },
          ],
        },
      ],
      exercises: [
        {
          ...
          labFile: "labs/phase_5_fs/README.md",
          hints: [
      ...
      acceptanceCriteria: [
        "make test 全部通过",
        "make qemu 能看到 phase_5 交付物的预期行为",
        "scripts/grade.py 评分为满分",
      ],
      references: [
        { title: "labs/phase_5_fs/COURSE.zh-CN.md", description: "[必读] 本 phase 的完整中文教材（课程大纲之外的所有细节都在这里）", url: "./labs/phase_5_fs/COURSE.zh-CN.md" },
...
export const phase5En: PhaseContent = {
  ...
  lessons: [
    {
      phaseId: 5, lessonId: 1,
      title: "Phase 5 Overview: Block Device & File System",
      subtitle: "Block Device & File System",
      type: "Concept + Practice",
      duration: "3-4 hours",
      objectives: [
        "Master the core mechanics of Block Device & File System",
      ...
      sections: [
        {
          ...
          blocks: [
            { type: "paragraph", text: "Phase 5 focuses on Block Device & File System. Open labs/phase_5_fs/COURSE.en.md for the full textbook (ASCII diagrams, code walk-through, common-mistake tables, three-tier references). This page is only a roadmap summary." },
            { type: "list", ordered: true, items: [
              "The 5-region easy-fs on-disk layout",
              "DiskInode: direct + indirect + double-indirect",
              "BlockCache: LRU + write-back"
            ]},
            { type: "callout", variant: "tip", text: "Open a terminal in labs/phase_5_fs/, run make test then make qemu, then read COURSE.en.md side-by-side with the code — the highest-bandwidth way to learn." },
          ],
        },
      ],
      exercises: [
      ...
      acceptanceCriteria: [
        ...
        "make qemu shows the expected phase_5 deliverable behavior",
        "scripts/grade.py reports a full score",
      ],
      references: [
        { title: "labs/phase_5_fs/COURSE.en.md", description: "[Required] The full English textbook for this phase (all the depth that doesn't fit the roadmap)", url: "./labs/phase_5_fs/COURSE.en.md" },
