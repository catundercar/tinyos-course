...
const LAB_FILE = "labs/phase_2_proc/COURSE.zh-CN.md";
const LAB_FILE_EN = "labs/phase_2_proc/COURSE.en.md";

export const phase2ZhCN: PhaseContent = {
  phaseId: 2, color: "#059669", accent: "#34D399",
  lessons: [
    {
      phaseId: 2, lessonId: 1,
      title: "Phase 2 导读：进程与调度",
      ...
      sections: [
        {
          title: "本 Phase 的关键主题",
          blocks: [
            { type: "paragraph", text: "Phase 2 聚焦于 进程与调度。完整教材（含 ASCII 图、代码剖析、常见错误表、三层级参考资料）请打开 labs 目录下的 COURSE.zh-CN.md 阅读；这里只做路线摘要。" },
            { type: "list", ordered: true, items: [
              "TCB 与 TaskContext 结构",
              "__switch 14 行汇编的奥秘",
              "时钟中断与 Round-Robin 时间片"
            ]},
            { type: "callout", variant: "tip", text: "打开终端进入 labs/phase_2_proc/，先 make test 再 make qemu，再读 COURSE.zh-CN.md 对照代码——这是最高效的学习路径。" },
          ],
        },
      ],
      exercises: [
        {
          ...
          labFile: "labs/phase_2_proc/README.md",
          hints: [
      ...
      acceptanceCriteria: [
        "make test 全部通过",
        "make qemu 能看到 phase_2 交付物的预期行为",
        "scripts/grade.py 评分为满分",
      ],
      references: [
        { title: "labs/phase_2_proc/COURSE.zh-CN.md", description: "[必读] 本 phase 的完整中文教材（课程大纲之外的所有细节都在这里）", url: "./labs/phase_2_proc/COURSE.zh-CN.md" },
...
export const phase2En: PhaseContent = {
  ...
  lessons: [
    {
      phaseId: 2, lessonId: 1,
      title: "Phase 2 Overview: Process & Scheduling",
      subtitle: "Process & Scheduling",
      type: "Concept + Practice",
      duration: "3-4 hours",
      objectives: [
        "Master the core mechanics of Process & Scheduling",
      ...
      sections: [
        {
          ...
          blocks: [
            { type: "paragraph", text: "Phase 2 focuses on Process & Scheduling. Open labs/phase_2_proc/COURSE.en.md for the full textbook (ASCII diagrams, code walk-through, common-mistake tables, three-tier references). This page is only a roadmap summary." },
            { type: "list", ordered: true, items: [
              "TCB & TaskContext structure",
              "The magic of __switch — 14 lines of asm",
              "Timer interrupt + Round-Robin slicing"
            ]},
            { type: "callout", variant: "tip", text: "Open a terminal in labs/phase_2_proc/, run make test then make qemu, then read COURSE.en.md side-by-side with the code — the highest-bandwidth way to learn." },
          ],
        },
      ],
      exercises: [
      ...
      acceptanceCriteria: [
        ...
        "make qemu shows the expected phase_2 deliverable behavior",
        "scripts/grade.py reports a full score",
      ],
      references: [
        { title: "labs/phase_2_proc/COURSE.en.md", description: "[Required] The full English textbook for this phase (all the depth that doesn't fit the roadmap)", url: "./labs/phase_2_proc/COURSE.en.md" },
